...
BOT_TOKEN = environ.get('BOT_TOKEN', '7824769227:AAE3RWoGMxV2ziZiv-mhp7aRmaomaGD4olc')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5906206984').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Movieuploder1982") # ADMIN USERNAME
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002610824638').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002268338808')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002268338808'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002457868984') # If anyone sends a request message to your bot, you will get it in this channel.
...
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Tamil_LinksZzz/36")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "ea7dec972a0670994ad2f4e6be0dc10688fb8db4")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/eafee0a36a1f84863011c-21313e3942eeda7303.jpg')).split()
