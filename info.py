...
API_ID = int(environ.get('API_ID', '28638866'))
API_HASH = environ.get('API_HASH', 'a748074bea1e6ace57394aceb194d292')
BOT_TOKEN = environ.get('BOT_TOKEN', 'Fuck')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5906206984 7119076396').split()]
USERNAME = environ.get('USERNAME', "https://t.me/vedisz") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002541390598'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/smileymovieshd5')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002511881245').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002656535628'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002629195204')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002295628555'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002250340602')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002343997444'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002462680926') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002250340602')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+j38dCGBK5DVkY2Vl') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/Y8L.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://graph.org/file/afa81500498e9e5cdc348-fa5e4547720076c405.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/41872ac40d870aa2596ee-cac1c1da3ecdb46ea8.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/41872ac40d870aa2596ee-cac1c1da3ecdb46ea8.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://lucypro.koyeb.app")
